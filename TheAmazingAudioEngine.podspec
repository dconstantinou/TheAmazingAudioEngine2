Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/dconstantinou/TheAmazingAudioEngine2", :branch => "develop" }
  s.ios.deployment_target = '8.0'
  s.source_files = 'TheAmazingAudioEngine/**/*.{h,m,c}'
  s.exclude_files = 'TheAmazingAudioEngine/Modules/Generation/AEAudiobusInputModule.*'
